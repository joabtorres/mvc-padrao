...
class CrudModel extends model
{
    ...
    /**
     * String $numRows - referente a quantidade de linhas obtidas no select;
     * @access private
     * @author Joab Torres <joabtorres1508@gmail.com>
     */
    private $numRows;
    ...
    /**
     * Está função é responsável para salva uma imágem no diretório uploads/
     * @access public
